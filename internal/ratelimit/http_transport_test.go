...
func TestHTTP_Check_ReturnsRuleNotFoundErrorCode(t *testing.T) {
	...
	payload, err := json.Marshal(httpCheckRequest{
		TenantID: "tenant",
		UserID:   "user",
		Resource: "resource",
		Cost:     1,
...
func TestHTTP_CheckBatch_PreservesOrder(t *testing.T) {
	...
	var responses []httpCheckResponse
...
func newHTTPTestServer(t *testing.T, app *Application) *httptest.Server {
	t.Helper()
	transport := NewHTTPTransport(":0", func() bool { return true })
