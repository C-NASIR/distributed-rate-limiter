...
func waitForNewLimiter(t *testing.T, pool *core.LimiterPool, old core.Limiter) *core.LimiterHandle {
...
func newTestLimiterPool(rules *core.RuleCache, policy core.LimiterPolicy) *core.LimiterPool {
	redis := newTestRedis()
	...
	return core.NewLimiterPool(rules, factory, policy)
}
