// Package core provides cache invalidation subscribers.
package core
...
func NewCacheInvalidator(db RuleDB, rules *RuleCache, pool *LimiterPool, pubsub PubSub, channel string) *CacheInvalidator {
